...
vsm::result<unique_socket_with_flags> allio::socket_accept(socket_type const listen_socket, socket_address& addr, listen_socket_handle::accept_parameters const& args)
{
