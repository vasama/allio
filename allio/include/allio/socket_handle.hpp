...
vsm::result<final_handle<stream_socket_handle_base>> block_connect(network_address const& address, stream_socket_handle_base::connect_parameters const& args);
vsm::result<final_handle<listen_socket_handle_base>> block_listen(network_address const& address, listen_socket_handle_base::listen_parameters const& args);
