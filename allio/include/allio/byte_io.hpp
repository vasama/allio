...
struct parameters<scatter_read_at> : scatter_gather_parameters
{
	...
	parameters(auto const& args, file_size const offset, read_buffer const buffer)
		: scatter_gather_parameters{ args, buffer, offset }
	{
	}

	parameters(auto const& args, file_size const offset, read_buffers const buffers)
...
struct parameters<gather_write_at> : scatter_gather_parameters
{
	...
	parameters(auto const& args, file_size const offset, write_buffer const buffer)
		: scatter_gather_parameters{ args, buffer, offset }
	{
	}

	parameters(auto const& args, file_size const offset, write_buffers const buffers)
		: scatter_gather_parameters{ args, as_untyped_buffers(buffers), offset }
	{
	}
};
