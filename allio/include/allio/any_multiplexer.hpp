...
struct operation_vtable
{
	...
	vsm::result<io_result>(*submit)(void* m, handle_type& h, C const& c, S& s, void* r, io_status status);
	vsm::result<io_result>(*notify)(void* m, handle_type& h, C const& c, S& s, void* r);
	...
	template<typename M>
	static vsm::result<io_result> _submit(
		void* const m,
		handle_type& h,
		C const& c,
		S& s,
	...
	template<typename M>
	static vsm::result<io_result> _notify(
		void* const m,
		handle_type& h,
		C const& c,
		S& s,
