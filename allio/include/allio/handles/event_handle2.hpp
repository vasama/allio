...
class event_handle_impl : public platform_handle
{
protected:
...
protected:
	allio_detail_default_lifetime(event_handle_impl);
...
using event_handle = basic_handle<detail::event_handle_impl>;

template<typename Multiplexer>
using basic_event_handle = basic_async_handle<detail::event_handle_impl, Multiplexer>;
...
template<>
struct io_operation_traits<event_handle::create_tag>
{
...
template<>
struct io_operation_traits<event_handle::wait_tag>
{
