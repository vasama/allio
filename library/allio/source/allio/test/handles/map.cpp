...
TEST_CASE("The protection of anonymous mappings can be changed", "[map][hardware_exception]")
{
	...
	if (set_write_only())
	{
		// Write-only mappings are most likely not supported, but if it happens that they are, test
