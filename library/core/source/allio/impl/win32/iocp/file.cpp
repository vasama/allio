...
using read_t = file_t::random_read_t;
using read_s = async_operation_t<M, file_t, read_t>;
using read_a = io_parameters_t<file_t, read_t>;
...
using write_t = file_t::random_write_t;
using write_s = async_operation_t<M, file_t, write_t>;
using write_a = io_parameters_t<file_t, write_t>;
