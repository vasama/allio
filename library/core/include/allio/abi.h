...
enum allio_abi_result
{
	...
	/// @brief The operation could not be completed. Retry by polling the handle again.
...
struct allio_abi_handle_functions
{
	...
	/// @brief Notify the handle of poll completion. The user of an opaque handle should invoke this
	///        function when polling the handle completes successfully.
