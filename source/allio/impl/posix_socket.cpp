...
{
	result<socket_address> r(result_value);
...
result<unique_socket_with_flags> allio::create_socket(network_address_kind const address_kind, common_socket_handle::create_parameters const& args)
{
	int address_family;
...
result<void> allio::listen_socket(socket_type const socket, network_address const& address, listen_socket_handle::listen_parameters const& args)
{
...
static result<void> sync_create_socket(io::parameters_with_result<io::socket_create> const& args)
{
	...
	allio_TRY(socket, create_socket(args.address_kind, args));
	return initialize_socket_handle(h, std::move(socket.socket),
...
result<void> detail::stream_socket_handle_base::sync_impl(io::parameters_with_result<io::socket_create> const& args)
{
	return sync_create_socket<stream_socket_handle>(args);
}

result<void> detail::stream_socket_handle_base::sync_impl(io::parameters_with_result<io::socket_connect> const& args)
{
	...
	allio_TRY(addr, socket_address::make(args.address));
...
result<void> detail::stream_socket_handle_base::sync_impl(io::parameters_with_result<io::stream_scatter_read> const& args)
{
	return args.produce(sync_scatter_read(static_cast<platform_handle const&>(*args.handle), args));
}

result<void> detail::stream_socket_handle_base::sync_impl(io::parameters_with_result<io::stream_gather_write> const& args)
{
...
result<void> detail::packet_socket_handle_base::sync_impl(io::parameters_with_result<io::socket_create> const& args)
{
	return sync_create_socket<packet_socket_handle>(args);
}

result<void> detail::packet_socket_handle_base::sync_impl(io::parameters_with_result<io::packet_scatter_read> const& args)
{
	return packet_scatter_read(args);
}

result<void> detail::packet_socket_handle_base::sync_impl(io::parameters_with_result<io::packet_gather_write> const& args)
{
...
result<void> detail::listen_socket_handle_base::sync_impl(io::parameters_with_result<io::socket_create> const& args)
{
	return sync_create_socket<listen_socket_handle>(args);
}

result<void> detail::listen_socket_handle_base::sync_impl(io::parameters_with_result<io::socket_listen> const& args)
{
...
result<void> detail::listen_socket_handle_base::sync_impl(io::parameters_with_result<io::socket_accept> const& args)
{
	...
	socket_address addr;
	allio_TRY(socket, accept_socket(unwrap_socket(h.get_platform_handle()), addr, args));

	result<accept_result> result(result_value);
	allio_TRYV(initialize_socket_handle(
		args.result->socket, std::move(socket.socket),
		[&](native_platform_handle const socket_handle)
		{
			return platform_handle::native_handle_type
			{
