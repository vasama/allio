...
#include <allio/impl/atomic_spin_hint.hpp>
...
result<multiplexer::statistics> manual_multiplexer::pump(pump_parameters const& args)
{
...
#if 0
result<multiplexer::statistics> manual_multiplexer::submit(deadline const deadline)
{
	return {};
}

result<multiplexer::statistics> manual_multiplexer::poll(deadline const deadline)
{
}

result<multiplexer::statistics> manual_multiplexer::submit_and_poll(deadline const deadline)
{
