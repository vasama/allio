...
result<unique_handle> open_process(process_id pid, process_handle::open_parameters const& args);
result<process_info> launch_process(input_path_view path, process_handle::launch_parameters const& args);
