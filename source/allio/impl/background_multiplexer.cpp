...
result<async_operation_ptr> background_multiplexer::construct(async_operation_descriptor const& descriptor, storage_ptr const storage, async_operation_parameters const& arguments, async_operation_listener* const listener)
{
	result<async_operation_ptr> r = m_multiplexer->construct(descriptor, storage, arguments, listener);
...
result<void> background_multiplexer::start(async_operation_descriptor const& descriptor, async_operation& operation)
{
...
result<async_operation_ptr> background_multiplexer::construct_and_start(async_operation_descriptor const& descriptor, storage_ptr const storage, async_operation_parameters const& arguments, async_operation_listener* const listener)
{
	result<async_operation_ptr> r = m_multiplexer->construct_and_start(descriptor, storage, arguments, listener);
...
result<void> background_multiplexer::cancel(async_operation_descriptor const& descriptor, async_operation& operation)
{

}

result<void> background_multiplexer::block(async_operation_descriptor const& descriptor, async_operation_parameters const& arguments)
{
